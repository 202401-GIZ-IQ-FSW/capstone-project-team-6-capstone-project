...
// const Sidebar = ({ ticketId, issueDescription, category, onInputChange, onCreateTicket }) => {
//     return (
//       <div className="bg-gray-100 h-full w-64 flex flex-col p-4">
//         {/* Back Icon */}
...
//         {/* Ticket ID */}
//         <div className="mb-4">
//           <label htmlFor="ticketId" className="text-sm text-gray-600 mb-1 block">
//             Ticket ID
//           </label>
//           <input
//             id="ticketId"
...
//             value={ticketId}
//             onChange={(e) => onInputChange('ticketId', e.target.value)}
//           />
//         </div>
  
//         {/* Issue Description */}
//         <div className="mb-4">
//           <label htmlFor="issueDescription" className="text-sm text-gray-600 mb-1 block">
//             Issue Description
//           </label>
//           <textarea
//             id="issueDescription"
...
//             onChange={(e) => onInputChange('issueDescription', e.target.value)}
//           />
//         </div>
...
//         {/* Attachment */}
//         <div className="mb-4">
//           <label htmlFor="attachment" className="text-sm text-gray-600 mb-1 block">
//             Attachment
//           </label>
//           <input
//             id="attachment"
