...
const Navbar = () => {
  ...
  const navItems =
    <>
      ...
      {signedIn && <li><Link href="/profile">Profile</Link></li>}
    </>
      ...
      <div className="navbar xl:px-24">
        <div className="navbar-start">
          <div className="dropdown">
            <div onClick={toggleDropdown} tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
          ...
          <Link href="/" className="btn btn-ghost text-xl">
            <img src="/R.png" alt="Logo" className="h-10 w-10 mr-4" />  <span>Tickets</span>    
          </Link>
        </div>
