      ...
      { signedIn === true && 
        <div className="bg-white text-gray-900 flex justify-center mx-auto px-4 py-4">
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="w-screen text-gray-900 lg:w-full py-4 px-6">
              <div className="flex items-center justify-between p-4 rounded-lg text-gray-900  border-gray-500 border-2 gap-4">
                <h1 className="font-bold lg:text-3xl text-gray-900 ">Tickets</h1>
                <Link href="/tickets/new-ticket" className="bg-gray-800  btn">
                  New ticket
                </Link>
              </div>
            </div>
            ...
            { tickets.length > 0 ? (
              ...
              <p className=" text-gray-900 m-10 font-semibold">{error}</p>
            )}
